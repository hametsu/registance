...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<h2>運営からご連絡</h2>
		<h3>2012.04.20:サーバーの不具合により、ゲームプレイ不可能の件について</h3>
		<p>運営こと似非原です。22:00から23:00の間において、ゲームプレイが不可能になっていた件について、原因が発覚したのでお知らせします。</p>
		<p>ゲームプレイが不可能になっていたのは、サーバー上において保管されているログが肥大化していたために、空き容量が無くなり、部屋のログが書き込むことが出来なくなったために起きたものだと考えられます。サーバーのログを削除するとともに、今後起きないように、ログの肥大化への対策を行いたいと思います。</p>
	<h2>過去ログ</h2>
